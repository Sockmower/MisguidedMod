...
import static dev.sockmower.misguidedmod.repack.io.airlift.compress.zstd.Constants.MAX_WINDOW_LOG;
import static dev.sockmower.misguidedmod.repack.io.airlift.compress.zstd.Constants.MIN_WINDOW_LOG;
...
class CompressionParameters
{
    ...
    public static CompressionParameters compute(int compressionLevel, int inputSize)
    {
        ...
        if (inputSize < maxWindowResize) {
            ...
            int inputSizeLog = (inputSize < hashSizeMin) ? MIN_HASH_LOG : Util.highestBit(inputSize - 1) + 1;
