...
import static dev.sockmower.misguidedmod.repack.io.airlift.compress.zstd.Huffman.MAX_FSE_TABLE_LOG;
import static dev.sockmower.misguidedmod.repack.io.airlift.compress.zstd.Huffman.MAX_SYMBOL;
import static dev.sockmower.misguidedmod.repack.io.airlift.compress.zstd.Huffman.MAX_SYMBOL_COUNT;
import static dev.sockmower.misguidedmod.repack.io.airlift.compress.zstd.Huffman.MAX_TABLE_LOG;
import static dev.sockmower.misguidedmod.repack.io.airlift.compress.zstd.Huffman.MIN_TABLE_LOG;
...
final class HuffmanCompressionTable
{
    ...
    {
        Util.checkArgument(maxSymbol <= MAX_SYMBOL, "Max symbol value too large");
        ...
        Util.checkArgument(maxNumberOfBits <= MAX_TABLE_LOG, "Max number of bits larger than max table size");
