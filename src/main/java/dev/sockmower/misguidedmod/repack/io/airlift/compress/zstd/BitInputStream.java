...
class BitInputStream
{
    ...
    static long readTail(Object inputBase, long inputAddress, int inputSize)
    {
        ...
        switch (inputSize) {
            case 7:
                bits |= (UnsafeUtil.UNSAFE.getByte(inputBase, inputAddress + 6) & 0xFFL) << 48;
            case 6:
                bits |= (UnsafeUtil.UNSAFE.getByte(inputBase, inputAddress + 5) & 0xFFL) << 40;
            case 5:
                bits |= (UnsafeUtil.UNSAFE.getByte(inputBase, inputAddress + 4) & 0xFFL) << 32;
            case 4:
                bits |= (UnsafeUtil.UNSAFE.getByte(inputBase, inputAddress + 3) & 0xFFL) << 24;
            case 3:
                bits |= (UnsafeUtil.UNSAFE.getByte(inputBase, inputAddress + 2) & 0xFFL) << 16;
            case 2:
                bits |= (UnsafeUtil.UNSAFE.getByte(inputBase, inputAddress + 1) & 0xFFL) << 8;
        }
    ...
    static class Initializer
    {
        ...
        public void initialize()
        {
            ...
            int lastByte = UnsafeUtil.UNSAFE.getByte(inputBase, endAddress - 1) & 0xFF;
